...
\begin{frame}{Backpropagation}{Question c) (i)}
    \begin{itemize}
        ...
        \item Assume you are training your model with the following training
              objective:
              \begin{align*}
        ...
        \item Using squared error loss for a classification task is not a
...
\begin{frame}{Backpropagation}{Question c) (ii)}
    \begin{itemize}
        ...
        \item Assuming that all weights are initialized to $w = 1$, carry
              ...
              supervision.
        \item Use learning rate $\psi = 1$ and the squared error
              loss given above.
    \end{itemize}
\end{frame}
