...
This task is based on a previous task written by Prof.\ Dr.\ Goran Glava\v{s}. \\
    ...
    \item You are given the toy feed-forward neural network shown in the figure
          ...
          \begin{enumerate}[label=(\roman*)]
              \item Derive the update rule for the weights marked in red in the
                    ...
                    Assume you are training your model with the following 
                    training objective:
                    \begin{align*}
                    ...
                    Using squared error loss for a classification task is not a
