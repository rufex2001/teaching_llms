...
\begin{enumerate}[label=(\alph*)]
    ...
    \item Here we can get an idea of how to use pre-trained LLMs to construct
          ...
          There are repositories out there who have collected system prompts 
          from various LLM-based products for learning purposes, e.g.\ 
          \href{https://github.com/0xeb/TheBigPromptLibrary}{this one} or
          \href{https://github.com/guy915/System-Prompts}{this one}.
\end{enumerate}
