...
\begin{frame}{Transfer Learning}{Answer c) (1)}
    \begin{itemize}
        \item The CLM likelihood is defined as follows:
              \begin{align}
                  \op{CLM}(S) & = \prod_{s=1}^{S} p(x_{|s|} \mid x_1, x_2, \ldots, x_{|s|-1}),
              \end{align}
              where $x_i$ are tokens in sequence $s$.
        \item Similarly, the MLM likelihood is defined as follows:
              \begin{align}
...
\begin{frame}{Transfer Learning}{Answer c) (2)}
    \begin{itemize}
        \item We use these likelihoods with empirical risk minimization and log
