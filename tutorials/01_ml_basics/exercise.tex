...
% header and footer
\lhead{Advanced Methods in Text Analytics, FSS2026}
\chead{}
\rhead{\thepage\ }
\cfoot{}
\pagestyle{fancy}
...
\author{Daniel Ruffinelli \\ \href{https://creativecommons.org/licenses/by/4.0/}{Licensed under Creative Commons Attribution 4.0 International}}
\date{FSS 2026}
...
\begin{enumerate}[label=(\alph*)]
    ...
    \item \emph{Log}-linear models are those that model classification as a
          ...
          applied to it.
          Give a formal expression for the output given by a \emph{general}
          log-linear model $f(y\mid\vx)$ parameterized by $\vw$, where
          $\vx,\vw\in\bb{R}^n$.
    \item How can you modify your answer from the previous question so the model
          is designed for multi-class classification. How many parameters does 
          this model have?
