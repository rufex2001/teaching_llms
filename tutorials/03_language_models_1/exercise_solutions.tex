...
\begin{enumerate}[label=(\alph*)]
    ...
    \item N-gram models assume that predicting a given word $x_n$ only depends
          ...
          sequence as follows:
          \begin{align*}
              p(x_1,\ldots,x_{n-1},x_n) = p(x_1)p(x_2|x_1)p(x_3|x_2)\ldots p(x_n|x_{n-1}).
          \end{align*}
          Similarly, for trigram models, we have:
          \begin{align*}
              p(x_1,\ldots,x_{n-1},x_n) = p(x_1)p(x_2|x_1)p(x_3|x_1,x_2)\ldots p(x_n|x_{n-2},x_{n-1}).
          \end{align*}
          ...
          \begin{align*}
              p(<s>,x_1,\ldots,x_n,</s>) = p(x_1|\text{<s>})p(x_2|x_1)p(x_3|x_2)\ldots p(x_n|x_{n-1})p(</s>|x_n).
          \end{align*}
